...
class C01Person{
	...
	public C01Person(String name, String addr) {
		this.addr = addr;
		this.name = name;
	}
}

//클래스 자료형을 요소로 하는 배열객채를 생성하는 경우;
//각 요소는 객체의 위치값을 담는 참조변수로 사용된다.
//각 요소마다 객체생성이후 위치값을 저장을 해야 데이터를 저장하거나 기능을 사용할 수가 있다.
...
public class C01ClassArrayMain {
	public static void main(String[] args) {
		...
		System.out.println(list[0].name + list[0].addr);
